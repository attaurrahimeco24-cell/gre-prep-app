...
def generate_2000_questions():
    ...
    for _ in range(300):
        ...
        ans = (c - b) / a
        q = {
            "question_id": f"Q-ALG-{uuid.uuid4().hex[:6]}",
            "section": "Quantitative Reasoning",
            "domain": "Algebra", "topic": "Linear Equations",
            "question_type": "Numeric Entry", "difficulty_level": random.randint(1, 5),
            "question_text": f"If {a}x + {b} = {c}, what is the exact value of x?",
            "options": None,
            "correct_answer": f"{ans:.2f}".rstrip('0').rstrip('.'),
    ...
    for _ in range(200):
        ...
        area = 0.5 * b * h
        q = {
            "question_id": f"Q-GEO-{uuid.uuid4().hex[:6]}",
            "section": "Quantitative Reasoning",
    ...
    for _ in range(300):
        ...
        ans = orig * (1 + pct/100)
        q = {
            "question_id": f"Q-ARI-{uuid.uuid4().hex[:6]}",
            "section": "Quantitative Reasoning",
            "domain": "Arithmetic", "topic": "Percentages",
            "question_type": "Numeric Entry", "difficulty_level": random.randint(1, 4),
            "question_text": f"A store purchases an item for ${orig} and marks it up by {pct}%. What is the final selling price?",
            "options": None,
            "correct_answer": str(ans),
            "explanation": f"{pct}% of {orig} is {orig*(pct/100)}. {orig} + {orig*(pct/100)} = {ans}."
        }
        questions.append(q)
    ...
    for _ in range(400):
        ...
        q = {
            "question_id": f"Q-VER-{uuid.uuid4().hex[:6]}",
            "section": "Verbal Reasoning",
            "domain": "Text Completion", "topic": "Vocabulary in Context",
            "question_type": "Multiple Choice", "difficulty_level": random.randint(1, 5),
            "question_text": f"Despite the manager's attempts to ______ the situation, the employees remained extremely upset.",
            "options": ["mitigate", "exacerbate", "obfuscate", "prolong", "celebrate"],
            "correct_answer": "mitigate",
            "explanation": "The word 'Despite' indicates a contrast. 'Mitigate' means to make less severe."
        }
        questions.append(q)
    ...
    for _ in range(400):
        q = {
            "question_id": f"Q-VER-{uuid.uuid4().hex[:6]}",
            "section": "Verbal Reasoning",
            "domain": "Reading Comprehension", "topic": "Passage Analysis",
            "question_type": "Multiple Choice", "difficulty_level": random.randint(2, 5),
            ...
            "correct_answer": "Contrast two historical scientific paradigms",
            "explanation": "The passage shifts from 19th century determinism to modern environmental views."
        }
        questions.append(q)
    ...
    for _ in range(200):
        q = {
            ...
            "domain": "Issue Task", "topic": "Society & Technology",
            "question_type": "Issue Task", "difficulty_level": random.randint(3, 5),
            ...
            "explanation": "Score is based on logic, structure, and vocabulary."
        }
        questions.append(q)
...
def seed_initial_question_bank(force_reset=False):
    ...
    if count >= 1000 and not force_reset:
        return
